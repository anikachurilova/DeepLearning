...
# Improved CNN from scratch (with augmentation and dropout)
def create_improved_cnn():
    ...
    # Same CNN structure as the first model
...
confusion_matrix_file = tables_path / "improved_cnn_confusion_matrix.csv"